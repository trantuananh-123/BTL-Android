...
public class ChooseHealthFacilityActivity extends AppCompatActivity implements ViewHolderListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_health_facility);
    ...
    public void onClickItemRcvHolder(View view, int position) {
        ...
        Intent intent = new Intent(this, HealthFacilityDetailActivity.class);
